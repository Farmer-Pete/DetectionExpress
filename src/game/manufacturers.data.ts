  ...
  manufacturers: [
    {
      ...
      description:
        "The incumbent. Gatekeep has been screwing turnstiles into concrete since before most riders were born.",
      dataStyle:
    ...
    },
    {
      ...
      description:
        "The fintech upstart that has a slick app, aggressive roadmap, and a habit of deprecating fields mid-contract.",
      dataStyle:
    ...
    },
    {
      id: "railsense",
      name: "RailSense",
      tagline: "Takes a licking and keeps on ticketing.",
      description:
        "The rugged operational vendor. RailSense sensors keep reporting through tunnel floods, power dips, and abuse that would kill anything else.",
      dataStyle:
    ...
    },
    {
      ...
      description:
        "The enterprise surveillance giant. The branding is one focus group away from openly dystopian.",
      dataStyle:
    ...
    },
    {
      ...
      description:
        "The imported precision vendor, known to everyone as Tetsudo. Runs rolling stock and signals to the second and assumes you read the manual cover to cover.",
      dataStyle:
        "Romaji key names (jikoku for time, ressha for train, meirei for command), seconds since epoch, and full words for events. Precise and orderly, but the keys look like nothing else on the network.",
